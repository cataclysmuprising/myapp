 ...
 * 
 * @usage: $('.btn').pushMenu(options) or add [data-toggle="push-menu"] to any button Pass any option as data-option="value"
 */
+ function($) {
	'use strict'
...
/*
 * Tree() ====== Converts a nested list into a multilevel tree view menu.
 * 
 * @Usage: $('.my-menu').tree(options) or add [data-widget="tree"] to the ul element Pass any option as data-option="value"
 */
+ function($) {
	'use strict'
...
/*
 * ControlSidebar() =============== Toggles the state of the control sidebar
 * 
 * @Usage: $('#control-sidebar-trigger').controlSidebar(options) or add [data-toggle="control-sidebar"] to the trigger Pass any option as data-option="value"
 */
+ function($) {
	'use strict'
...
/*
 * BoxWidget() ====== Adds box widget functions to boxes.
 * 
 * @Usage: $('.my-box').boxWidget(options) This plugin auto activates on any element using the `.box` class Pass any option as data-option="value"
 */
+ function($) {
	'use strict'
...
/*
 * TodoList() ========= Converts a list into a todoList.
 * 
 * @Usage: $('.my-list').todoList(options) or add [data-widget="todo-list"] to the ul element Pass any option as data-option="value"
 */
+ function($) {
	'use strict'
