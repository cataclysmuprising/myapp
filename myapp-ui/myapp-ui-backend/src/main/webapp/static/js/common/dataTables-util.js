/*
 * ======================================================================================= 
 * dataTables-util.js ! version : 1.0 Copyright (c) 2017 - license.txt, Than Htike Aung
 *  ======================================================================================= 
 */
...
function generateAuthorizedButtonGroup(buttons) {
	...
	if (availableButtons.length == 0) {
		return '<i title="Actions do not allowed to perform." class="fa fa-times-circle-o text-red" style="font-size:18px;"></i>';
	}
