...
/*
 * @param tableSelector {string} pass table selector @param acceptanceElemSelector {string} you must define an element this can accept for value insert. <input type="hidden"> is preferable.
 */
